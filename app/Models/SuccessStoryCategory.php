...
class SuccessStoryCategory extends Model implements HasMedia
{
    use InteractsWithMedia, MediaUpload, SoftDeletes, SoftCascadeTrait, QueryScope, AdminTrackable;

    protected $guarded = ['id'];

    protected $softCascade = ['successStories'];
