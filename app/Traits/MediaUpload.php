...
trait MediaUpload
{
    ...
    /**
     * Check if the given media file is eligible for WebP conversion.
     *
     * @param Media|null $media
     * @return bool
     */
    protected function canConvertToWebp(?Media $media): bool
    {
        return $media && collect([
            ...
            'png',
            'bmp',
        ])->contains(Str::of($media->extension ?? '')->lower());
    }
}
