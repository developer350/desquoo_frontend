...
class FeatureController extends Controller
{
            ...
            return DataTables::eloquent($data)
                ...
                ->editColumn('sort_order', function ($row) {
                    return '<input type="text" value="' . $row->sort_order . '"
                        class="form-control w-50 sort-order numeric-input" data-model="Feature"
                ...
                ->editColumn('status', function ($row) {
                    ...
                    return '<div class="form-check form-switch">
                        <input type="checkbox" id="status' . base64_encode($row->id) . '" class="form-check-input toggle-switch" data-name="Status" data-labels="Enabled;Disabled" data-column="status" data-model="Feature"
                            value="' . $row->status . '"
    ...
    public function create()
    {
        ...
        return view('admin::features.form', compact('sort_order'));
    }
    ...
    public function store(FeatureRequest $request)
    {
        ...
        try {
            ...
            $feature->uploadMedia($request, 'icon');
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            ProductFeature::where('feature_id', $feature->id)->delete();
            ...
            return response()->json(['success' => false, 'message' => 'The requested Feature does not exist.']);
        } catch (\Throwable $e) {
            DB::rollBack();
            Log::error($e);
