...
class AdminController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            // check if the admin has order tracks
            if (OrderTrack::where('admin_id', $admin->id)->exists()) {
                return response()->json(['success' => false, 'message' => 'This admin has order tracks and cannot be deleted.']);
            }
