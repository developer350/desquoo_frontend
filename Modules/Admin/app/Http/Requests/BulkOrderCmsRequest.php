...
class BulkOrderCmsRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'section_five_button_title' => 'required|max:191',
            'section_five_image' => 'nullable|file|mimes:jpeg,png,jpg,webp|max:300',
            'section_five_image_alt_text' => 'nullable|max:191',
            'section_six_title' => 'required|max:191',
            'section_six_description' => 'required|max:5000',
        ];
    }
