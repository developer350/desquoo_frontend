        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('dashboard.index') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="@settings('website-favicon')" alt="@settings('website-name')" height="24">
                    </span>
                    <span class="logo-lg">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item bg-light-subtle border-start border-end"
                    ...
                    <img class="rounded-circle header-profile-user" src="{{ asset('backend/images/avatar.webp') }}"
                        alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1 fw-medium">{{ auth('admin')->user()->name }}</span>
                    <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    @if (auth('admin')->user()->can('app-settings'))
                        <a class="dropdown-item {{ request()->routeIs(['app-settings.index', 'app-settings.edit']) ? 'active' : '' }}"
