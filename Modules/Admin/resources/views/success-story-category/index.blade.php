...
@section('title', 'Success Story Categories')
@section('buttons')
    <a href="{{ route('success-story-categories.create') }}" class="btn btn-primary btn-sm">
    ...
    <script>
        $(document).ready(function() {
            initializeDataTable({
                ...
                ajaxOptions: {
                    url: "{{ route('success-story-categories.index') }}",
                }
            });
        });
    </script>
