...
@endsection
@section('buttons')
    <a href="{{ route('products.galleries.create', base64_encode($product->id)) }}" class="btn btn-primary btn-sm">
    ...
    <script>
        $(document).ready(function() {
            initializeDataTable({
                ...
                ajaxOptions: {
                    url: "{{ route('products.galleries.index', base64_encode($product->id)) }}",
                }
            });
        });
    </script>
