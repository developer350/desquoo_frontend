...
@push('js')
    ...
    <script>
        ...
        function regularInput(filePondRegularInputs = '.filepond-input') {
            $(filePondRegularInputs).each(function() {
                ...
                var pondOptions = {
                    ...
                    fileValidateTypeDetectType: function(source, type) {
                        if(accept && accept.includes('model/gltf-binary') && source.name.endsWith('.glb')){
                            return Promise.resolve('model/gltf-binary');
                        }else{
                            return Promise.resolve(type);
                        }
                    },
                    maxFileSize: size || '300KB',
                    credits: false,
                ...
                } else if (inputElement.attr('data-src')) {
                    pondOptions.files = [{
                        source: inputElement.attr('data-src'),
                    }];
                }
