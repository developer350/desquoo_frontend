                                ...
                                <tr>
                                    <td>
                                        <h1
                                            ...
                                            New Product Stock Alert Received
                                        </h1>
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <td style="padding: 25px 40px 30px;background-color: #151516;">
                                ...
                                <tr>
                                    <td style="padding: 0 0 20px;">
                                        ...
                                        <p
                                            ...
                                            Received on {{ $notify->created_at->format('F d, Y \a\t h:i A') }}
                                        </p>
                                    </td>
                                </tr>
                            </tbody>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="padding: 12px 15px; border-bottom: 1px solid #2a2a2b;">
                                                        ...
                                                        <p
                                                            style="margin: 0; font-family: 'Open Sans', sans-serif; font-size: 14px; font-weight: 400; color: #f4f4f4;">
                                                            @foreach ($notify->productVariant->attributeValues as $attributeValue)
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 12px 15px; border-bottom: 1px solid #2a2a2b;">
                                                        <p
                                                            style="margin: 0; font-family: 'Open Sans', sans-serif; font-size: 14px; font-weight: 400; color: #f4f4f4;">
                                                            <a href="mailto:{{ $notify->email }}"
                                                                style="color: #4a9eff; text-decoration: none;">{{ $notify->email }}</a>
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="padding: 12px 15px; border-bottom: 1px solid #2a2a2b;">
                                                        <p
                                                            style="margin: 0; font-family: 'Open Sans', sans-serif; font-size: 14px; font-weight: 400; color: #f4f4f4;">
                                                            <a href="tel:{{ $notify->formatted_phone_number }}"
                                                                style="color: #4a9eff; text-decoration: none;">{{ $notify->phone_number }}</a>
                                                        </p>
                                                    </td>
                                                </tr>
                                            </tbody>
                        ...
                        <table width="520" style="margin: 25px auto 0;">
                            <tbody>
                                <tr>
                                    <td style="text-align: center;">
                                        <a href="{{ route('notify-mes.index') }}" target="_blank"
