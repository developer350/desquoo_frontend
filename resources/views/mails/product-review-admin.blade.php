                                ...
                                <tr>
                                    <td style="padding: 0 0 20px;">
                                        ...
                                        <p
                                            ...
                                            Received on {{ $review->created_at->format('F d, Y \a\t h:i A') }}
                                        </p>
                                    </td>
                                </tr>
                            </tbody>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="padding: 12px 15px; vertical-align: top;">
                                                        <p style="margin: 0; font-family: 'Open Sans', sans-serif; font-size: 14px; font-weight: 600; color: #ffffff;">
                                                            Comment:
                                                        </p>
                                                    </td>
                                                    <td style="padding: 12px 15px;">
                                                        <p style="margin: 0; font-family: 'Open Sans', sans-serif; font-size: 14px; font-weight: 400; color: #f4f4f4; line-height: 22px;">
                                                            {{ $review->comment }}
                                                        </p>
                                                    </td>
                                                </tr>
