                            ...
                            <tbody>
                                <tr>
                                    <td style="padding: 0px 0 85px;">
                                        ...
                                        <p
                                            style="text-align: center; font-size: 14px; font-weight: 400;font-family: 'Open Sans', sans-serif; color: #f4f4f4; line-height: 26px; padding-top: 5px; margin-top:0px; margin-bottom: 0px;">
                                            Email id:
                                            <a href="mailto:{{ $user->email }}"
                                                style="color: #f4f4f4;font-family: 'Open Sans', sans-serif; text-decoration: none; display: inline-block; font-size: 14px; font-weight: 400;">
                                                {{ $user->email }}
                                            </a>
                                        </p>
                                    </td>
