                    ...
                    <td style="padding: 25px 40px 30px;background-color: #151516;">
                                ...
                                <tr>
                                    <td style="padding: 0 0 20px;">
                                        ...
                                        <p
                                            ...
                                            Received on {{ $comment->created_at->format('F d, Y \a\t h:i A') }}
                                        </p>
                                    </td>
                                </tr>
                            </tbody>
                                                    ...
                                                    <td style="padding: 12px 15px; border-bottom: 1px solid #2a2a2b;">
                                                        <p
                                                            ...
                                                            <a href="mailto:{{ $comment->email }}"
                                                                style="color: #4a9eff; text-decoration: none;">{{ $comment->email }}</a>
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="padding: 12px 15px;">
                                                        <p
                                                            style="margin: 0; font-family: 'Open Sans', sans-serif; font-size: 14px; font-weight: 400; color: #f4f4f4; line-height: 22px;">
                                                            {{ $comment->comment }}
                                                        </p>
                                                    </td>
                                                </tr>
                        ...
                        <table width="520" style="margin: 25px auto 0;">
                            <tbody>
                                <tr>
                                    <td style="text-align: center;">
                                        <a href="{{ route('blog-comments.index') }}" target="_blank"
