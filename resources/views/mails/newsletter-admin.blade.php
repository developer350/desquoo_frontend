                    ...
                    <td style="padding: 25px 40px 30px;background-color: #151516;">
                                                    ...
                                                    <td style="padding: 12px 15px; border-bottom: 1px solid #2a2a2b;">
                                                        <p
                                                            ...
                                                            <a href="mailto:{{ $newsletter->email }}"
                                                                style="color: #4a9eff; text-decoration: none;">{{ $newsletter->email }}</a>
                                                        </p>
                                                    </td>
                                                </tr>
                                            </tbody>
                        ...
                        <table width="520" style="margin: 25px auto 0;">
                            <tbody>
                                <tr>
                                    <td style="text-align: center;">
                                        <a href="{{ route('newsletter-subscriptions.index') }}" target="_blank"
